...
type FeedbackClickInfo = {
  variantInfo: { root: HTMLElement; variantId: VariantId };
  clickX: number;
  clickY: number;
};

type FeedbackElement = HTMLElement & { __feedbackClickInfo?: FeedbackClickInfo };
...
export function FeedbackOverlay({
  ...
  const handleDocumentClick = useCallback(
    (e: MouseEvent) => {
      ...
      (target as FeedbackElement).__feedbackClickInfo = {
        variantInfo,
        clickX: e.clientX,
        clickY: e.clientY,
      };
  ...
  const saveComment = () => {
    ...
    const clickInfo = (state.selectedElement as FeedbackElement).__feedbackClickInfo;
    if (!clickInfo) return;
    ...
    delete (state.selectedElement as FeedbackElement).__feedbackClickInfo;
  };
